...
#import "NearByUserTableCell.h"

@implementation NearByUserTableCell
...
//        [self addSubview:eventBtn];
        ...
        _loginTimeLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 80, 10, 70, 20)];
        _loginTimeLabel.textAlignment = NSTextAlignmentCenter;
        _loginTimeLabel.textColor = [UIColor grayColor];
        [_loginTimeLabel setFont:[UIFont systemFontOfSize:12.f]];
        [self addSubview:_loginTimeLabel];
        
        _nickNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(_userHeadImg.right+10.f, 10.f,SCREEN_WIDTH - _userHeadImg.right - 10 - 80 - 10, 20.f)];
        ...
        _distanceLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 80, _nickNameLabel.bottom, 70, 20)];
        _distanceLabel.textAlignment = NSTextAlignmentCenter;
        _distanceLabel.textColor = [UIColor grayColor];
        [_distanceLabel setFont:[UIFont systemFontOfSize:12.f]];
...
-(void)setUserInfoDict:(NSDictionary *)userInfoDict
{
    ...
    _loginTimeLabel.text = userInfoDict[@"login_time"];
    _distanceLabel.text = userInfoDict[@"distance"];
