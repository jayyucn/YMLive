//
//  ActivityLiveTableView.m
//  qianchuo
//
//  Created by 林伟池 on 16/10/25.
//  Copyright © 2016年 www.0x123.com. All rights reserved.
//

#import "ActivityLiveTableView.h"


@implementation ActivityLiveTableView
...
- (void)requestLiveData:(long)lastTime
{
    ...
    _isLoading = YES;
    [[Business sharedInstance] getActivityLives:lastTime succ:^(NSString *msg, id data) {
        if(lastTime == 0)
        {
            //刷新，如果是加载更多不用删除旧数据
