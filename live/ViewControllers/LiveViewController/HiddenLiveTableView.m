//
//  HiddenLiveTableView.m
//  qianchuo
//
//  Created by jacklong on 16/6/2.
//  Copyright © 2016年 www.0x123.com. All rights reserved.
//

#import "HiddenLiveTableView.h"

@implementation HiddenLiveTableView
...
- (void)requestLiveData:(long)lastTime
{
    ...
    _isLoading = YES;
    [[Business sharedInstance] getHiddenLives:lastTime succ:^(NSString *msg, id data) {
        if(lastTime == 0)
        {
            //刷新，如果是加载更多不用删除旧数据
