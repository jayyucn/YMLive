...
{
    static NSString *identifier = @"chat_cell_gift";
    ChatGiftCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[ChatGiftCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    ...
    {
        LiveGiftItemView *giftItemView=(LiveGiftItemView *)[cell viewWithTag:10+i];
