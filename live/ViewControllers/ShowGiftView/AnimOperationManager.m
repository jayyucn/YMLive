...
//        op.model.giftCount = op.presentView.animCount + 1;
        ...
        if ([userID integerValue] % 2) {
            ...
            if (op.model.giftCount != 0) {
                op.presentView.frame  = CGRectMake(-self.parentView.frame.size.width / 2, SCREEN_HEIGHT/2 + 10, self.parentView.frame.size.width *2/3, 40);
            ...
            if (op.model.giftCount != 0) {
                op.presentView.frame  = CGRectMake(-self.parentView.frame.size.width / 2,SCREEN_HEIGHT/2 - 50, self.parentView.frame.size.width *2/3, 40);
                op.presentView.originFrame = op.presentView.frame;
