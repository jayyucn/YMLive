...
#import "MyInfoViewController_d.h"
...
@interface MyInfoViewController_d()
{
    UserStateSegView *segStatecell;
...
@implementation MyInfoViewController_d
...
- (void)viewDidLoad
{
    ...
    NSArray *array = @[
                       ...
                       @[@{@"title":ESLocalizedString(@"我的收益"), @"icon":@"mypurse_x"},
                         @{@"title":ESLocalizedString(@"我的等级"), @"icon":@"vip"},
                         @{@"title":ESLocalizedString(@"我的钻石"), @"icon":@"mall_change_dimond"},
                         @{@"title":ESLocalizedString(@"我的直播"), @"icon":@"image/liveroom/my_live"}],
                       @[@{@"title":ESLocalizedString(@"设置"), @"icon":@"set"}]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0)
    {
        ...
        if (!segStatecell)
        {
            segStatecell = [[UserStateSegView alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
