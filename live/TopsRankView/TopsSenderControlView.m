...
@interface TopsSenderControlView()<SegmentViewDelegate>
{
    int currType;
...
@implementation TopsSenderControlView
...
- (void)viewDidLoad
{
    ...
    topLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 60)];
...
- (void)getTopsData:(int)page
{
    ...
    if (_isLiveUser && [LCMyUser mine].liveUserId)
    {
        parameter = @{@"type":@"all", @"liveuid":[LCMyUser mine].liveUserId, @"page":[NSNumber numberWithInt:page]};
    }
    else if (!_isLiveUser && [LCMyUser mine].userID)
    {
        if (_userId)
        {
             parameter = @{@"type":@"all", @"liveuid":_userId, @"page":[NSNumber numberWithInt:page]};
        }
        else
        {
             parameter = @{@"type":@"all", @"liveuid":[LCMyUser mine].userID, @"page":[NSNumber numberWithInt:page]};
        }
    }
...
- (void)getTopWeekData:(int)page
{
    ...
    if (_isLiveUser && [LCMyUser mine].liveUserId)
    {
        parameter = @{@"type":@"week", @"liveuid":[LCMyUser mine].liveUserId, @"page":[NSNumber numberWithInt:page]};
    }
    else if (!_isLiveUser && [LCMyUser mine].userID)
    {
        if (_userId)
        {
            parameter = @{@"type":@"week", @"liveuid":_userId, @"page":[NSNumber numberWithInt:page]};
        }
        else
        {
            parameter = @{@"type":@"week", @"liveuid":[LCMyUser mine].userID, @"page":[NSNumber numberWithInt:page]};
        }
    }
...
- (void)getTopDailyData:(int)page
{
    ...
    if (_isLiveUser && [LCMyUser mine].liveUserId)
    {
        parameter = @{@"type":@"day", @"liveuid":[LCMyUser mine].liveUserId, @"page":[NSNumber numberWithInt:page]};
    }
    else if (!_isLiveUser && [LCMyUser mine].userID)
    {
        if (_userId)
        {
            parameter = @{@"type":@"day", @"liveuid":_userId, @"page":[NSNumber numberWithInt:page]};
        }
        else
        {
            parameter = @{@"type":@"day", @"liveuid":[LCMyUser mine].userID, @"page":[NSNumber numberWithInt:page]};
        }
    }
