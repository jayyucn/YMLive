...
@interface TopsRankControlView()<SegmentViewDelegate>
{
    int currType;
...
@implementation TopsRankControlView
...
- (void)getTopsData:(int)page
{
    ...
    {
        parameter = @{@"liveuid":[LCMyUser mine].liveUserId, @"page":[NSNumber numberWithInt:page]};
    }
